...
def _hybrid_includes_keyword(ctx: dict[str, Any]) -> None:
...
def _hybrid_includes_vector(ctx: dict[str, Any]) -> None:
...
def _product_in_top_n(ctx: dict[str, Any], product_id: str, n: int) -> None:
