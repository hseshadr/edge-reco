...
def ctx(tmp_path: Path) -> dict[str, Any]:
    ...
    return {"tmp_path": tmp_path, "key_path": key_path, "verifier": Ed25519Verifier(public)}


@given("a signed catalog bundle with two products of equal popularity")
def _seed_bundle(ctx: dict[str, Any]) -> None:
...
def _engagement(ctx: dict[str, Any]) -> None:
...
def _retrain(ctx: dict[str, Any]) -> None:
...
def _verifies(ctx: dict[str, Any]) -> None:
